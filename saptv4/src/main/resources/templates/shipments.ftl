...
<head>
    ...
    <title>Упаковка продукции</title>
...
<div id="world">
    <div id="table-head" class="table-area">
        ...
        <#--<h3 align="center" class="special-header-color">Всего: ${sumQuantity} КГ Осталось: ${sumInProcess} КГ</h3>-->
        <table align="center">
            <caption class="table-caption-style">
                Данные по поставкам с ${time1} до ${time2}
            </caption>
